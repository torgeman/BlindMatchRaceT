...
public class MainActivity extends FragmentActivity implements LocationListener {
	...
	private MediaPlayer DistanceSounds[][] = new MediaPlayer[10][3];
	...
	private void initialize() {
		...
		DistanceSounds[0][0] = MediaPlayer.create(this, R.raw.beep_1_1);
		DistanceSounds[0][1] = MediaPlayer.create(this, R.raw.beep_1_2);
		DistanceSounds[0][2] = MediaPlayer.create(this, R.raw.beep_1_3);
		DistanceSounds[1][0] = MediaPlayer.create(this, R.raw.beep_2_1);
		DistanceSounds[1][1] = MediaPlayer.create(this, R.raw.beep_2_2);
		DistanceSounds[1][2] = MediaPlayer.create(this, R.raw.beep_2_3);
		DistanceSounds[2][0] = MediaPlayer.create(this, R.raw.beep_3_1);
		DistanceSounds[2][1] = MediaPlayer.create(this, R.raw.beep_3_2);
		DistanceSounds[2][2] = MediaPlayer.create(this, R.raw.beep_3_3);
		DistanceSounds[3][0] = MediaPlayer.create(this, R.raw.beep_4_1);
		DistanceSounds[3][1] = MediaPlayer.create(this, R.raw.beep_4_2);
		DistanceSounds[3][2] = MediaPlayer.create(this, R.raw.beep_4_3);
		DistanceSounds[4][0] = MediaPlayer.create(this, R.raw.beep_5_1);
		DistanceSounds[4][1] = MediaPlayer.create(this, R.raw.beep_5_2);
		DistanceSounds[4][2] = MediaPlayer.create(this, R.raw.beep_5_3);
		DistanceSounds[5][0] = MediaPlayer.create(this, R.raw.beep_6_1);
		DistanceSounds[5][1] = MediaPlayer.create(this, R.raw.beep_6_2);
		DistanceSounds[5][2] = MediaPlayer.create(this, R.raw.beep_6_3);
		DistanceSounds[6][0] = MediaPlayer.create(this, R.raw.beep_7_1);
		DistanceSounds[6][1] = MediaPlayer.create(this, R.raw.beep_7_2);
		DistanceSounds[6][2] = MediaPlayer.create(this, R.raw.beep_7_3);
		DistanceSounds[7][0] = MediaPlayer.create(this, R.raw.beep_8_1);
		DistanceSounds[7][1] = MediaPlayer.create(this, R.raw.beep_8_2);
		DistanceSounds[7][2] = MediaPlayer.create(this, R.raw.beep_8_3);
		DistanceSounds[8][0] = MediaPlayer.create(this, R.raw.beep_9_1);
		DistanceSounds[8][1] = MediaPlayer.create(this, R.raw.beep_9_2);
		DistanceSounds[8][2] = MediaPlayer.create(this, R.raw.beep_9_3);
		DistanceSounds[9][0] = MediaPlayer.create(this, R.raw.beep_10_1);
		DistanceSounds[9][1] = MediaPlayer.create(this, R.raw.beep_10_2);
		DistanceSounds[9][2] = MediaPlayer.create(this, R.raw.beep_10_3);



		//buoyBeep = MediaPlayer.create(this, R.raw.);
			...
			for (int i = 0; i < buoyRadiuses.length; i++) {
				if (buoyRadiuses[i] != null) {
					...
					if (distance[0] < buoyRadiuses[i].getRadius()) {
						...
						if(distance[0]>C.RADIUS_BUOY_ARRAY[1]){
							DistanceSounds[i][0].start();
						}else if(distance[0] > C.RADIUS_BUOY_ARRAY[2] && distance[0] <= C.RADIUS_BUOY_ARRAY[1]){
							DistanceSounds[i][1].start();
						}else{
							DistanceSounds[i][2].start();
						}
