	...
	private void initialize() {
		...
		findViewById(R.id.about).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				al.setTitle("About / Help");
				al.setMessage("Hello! The app is designed for race disposal Cruises for people with visual disabilities. You can two options: 1. Enter as admin allows to determine the location of buoys and thus build a new track. 2. Enter as a runner for viewing in your location, your speed and current direction while sailing. Also you can see the location of the other contestants. It is possible to produce a KML file which will contain the track it underwent during the race. If you want to sign in as admin. You must enter a username and password 'admin'. Otherwise: You can register and choose a username and password. You can also choose the number of the race and put him in the event box.");
				//al.setPositiveButton("OOKK",);
				//attemptLogin();
